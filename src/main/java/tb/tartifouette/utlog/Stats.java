...
public class Stats {
    ...
    private final Map<WhoKilledWhoWithWhat, Integer> statsKills1 =
    ...
    private final Map<WeaponPerKiller, Integer> statsWeapons =
    ...
    public void updateWhoKilledWhoWithWhat(String killer, String killed, String weapon) {
