...
public class DamageManager {
	...
	private void init() {
        ...
        addDamage(Weapon.P90, BodyPart.ARMS, 16);
        addDamage(Weapon.P90, BodyPart.LEGS, 15);
        addDamage(Weapon.P90, BodyPart.GROIN, 27);

        addDamage(Weapon.BERETTA, BodyPart.HEAD, 100);
        addDamage(Weapon.BERETTA, BodyPart.HELMET, 20);
        addDamage(Weapon.BERETTA, BodyPart.TORSO, 40);
        addDamage(Weapon.BERETTA, BodyPart.KEVLAR, 22);
        addDamage(Weapon.BERETTA, BodyPart.ARMS, 13);
        addDamage(Weapon.BERETTA, BodyPart.LEGS, 13);
